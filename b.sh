...
sudo apt-get -qq -y install pandoc pandoc-citeproc r-base-core qpdf texlive-latex-base texlive-base  xzdec texinfo ccache tex4ht texlive-fonts-extra r-cran-rcurl
